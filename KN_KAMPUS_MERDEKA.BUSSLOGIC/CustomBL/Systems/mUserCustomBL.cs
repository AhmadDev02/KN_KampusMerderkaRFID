...
namespace KN_KAMPUS_MERDEKA.BUSSLOGIC.CustomBL.Systems
{
    public static class mUserCustomBL
    {
        ...
        #endregion
        public static mUser parseFromJSON(JObject jsonDat)
        {
            mUser dat = new mUser();
            dat.bitActive = HelperConverter.ParseToBoolean(jsonDat["bitActive"].ToString());
            dat.bitUseActiveDirectory = HelperConverter.ParseToBoolean(jsonDat["bitUseActiveDirectory"].ToString());
            dat.dtmInsertedDate = HelperConverter.ParseToDateTime(jsonDat["dtmInsertedDate"].ToString());
            dat.dtmUpdatedDate = HelperConverter.ParseToDateTime(jsonDat["dtmUpdatedDate"].ToString());
            dat.dtmLastLogin = HelperConverter.ParseToDateTime(jsonDat["dtmLastLogin"].ToString());
            dat.intUserID = HelperConverter.ParseToInteger(jsonDat["intUserID"].ToString());
            dat.txtEmail = HelperConverter.ParseToString(jsonDat["txtEmail"].ToString());
            dat.txtEmpID = HelperConverter.ParseToString(jsonDat["txtEmpID"].ToString());
            dat.txtFullName = HelperConverter.ParseToString(jsonDat["txtFullName"].ToString());
            dat.txtNick = HelperConverter.ParseToString(jsonDat["txtNick"].ToString());
            dat.txtPassword = HelperConverter.ParseToString(jsonDat["txtPassword"].ToString());
            dat.txtUserName = HelperConverter.ParseToString(jsonDat["txtUserName"].ToString());
            dat.txtInsertedBy = HelperConverter.ParseToString(jsonDat["txtInsertedBy"].ToString());
            dat.txtUpdatedBy = HelperConverter.ParseToString(jsonDat["txtUpdatedBy"].ToString());
            dat.txtGUID = HelperConverter.ParseToString(jsonDat["txtGUID"].ToString());
            ...
            dat.dtmUpdatedDate = DateTime.Parse(dat.dtmUpdatedDate.ToString()).AddHours(TimeZone.CurrentTimeZone.GetUtcOffset(new DateTime()).Hours);
            dat.dtmLastLogin = DateTime.Parse(dat.dtmLastLogin.ToString()).AddHours(TimeZone.CurrentTimeZone.GetUtcOffset(new DateTime()).Hours);
